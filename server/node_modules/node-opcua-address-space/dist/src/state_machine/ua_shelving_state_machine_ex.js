...
exports._clear_timer_if_any = exports.UAShelvedStateMachineExImpl = void 0;
// --------------------------------------------------------------------------------------------------
...
class UAShelvedStateMachineExImpl extends finite_state_machine_1.UAStateMachineImpl {
    static promote(object) {
        ...
        (0, node_opcua_assert_1.assert)(shelvingState instanceof UAShelvedStateMachineExImpl);
        return shelvingState;
    }
}
exports.UAShelvedStateMachineExImpl = UAShelvedStateMachineExImpl;
