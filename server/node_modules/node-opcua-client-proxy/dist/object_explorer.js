    ...
    async_1.default.series([
        (callback) => {
            session.getArgumentDefinition(reference.nodeId, (err, argumentDefinition) => {
                ...
                async_1.default.series([
                    (innerCallback) => async_1.default.eachSeries(inputArguments, _extractDataType, innerCallback),
                    (innerCallback) => async_1.default.eachSeries(outputArguments, _extractDataType, innerCallback)
                ], (err) => callback(err));
            });
        },
        (callback) => {
...
function readUAStructure(proxyManager, obj, callback) {
    ...
    session.browse(nodesToBrowse, (err, browseResults) => {
        ...
        async_1.default.series([
            (callback) => {
                async_1.default.mapSeries(browseResults[0].references, (reference, innerCallback) => add_component(proxyManager, obj, reference, innerCallback), (err) => callback(err));
            },
            (callback) => {
                async_1.default.mapSeries(browseResults[1].references, (reference, innerCallback) => add_property(proxyManager, obj, reference, innerCallback), (err) => callback(err));
            },
            // now enrich our object with nice callable async methods
            (callback) => {
                async_1.default.mapSeries(browseResults[2].references, (reference, innerCallback) => add_method(proxyManager, obj, reference, innerCallback), (err) => callback(err));
            },
            ...
            // Organizes
            (callback) => {
                async_1.default.mapSeries(browseResults[6].references, (reference, callback) => addFolderElement(proxyManager, obj, reference, callback), (err) => callback(err));
            }
        ], (err) => callback(err));
    });
}
