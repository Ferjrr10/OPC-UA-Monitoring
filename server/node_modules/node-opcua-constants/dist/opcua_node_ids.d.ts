...
export declare enum VariableIds {
    ...
    ProvisionableDevice_RequestTickets_OutputArguments = 29881,
    ProvisionableDevice_SetRegistrarEndpoints_InputArguments = 29883,
    ...
    DefaultHAConfiguration_AggregateConfiguration_TreatUncertainAsBad = 32639,
    DefaultHAConfiguration_AggregateConfiguration_PercentDataBad = 32640,
    DefaultHAConfiguration_AggregateConfiguration_PercentDataGood = 32641,
    DefaultHAConfiguration_AggregateConfiguration_UseSlopedExtrapolation = 32642,
    ...
    PublishSubscribe_PubSubCapablities_MaxSecurityGroups = 32839,
    PublishSubscribe_PubSubCapablities_MaxPushTargets = 32840,
    PublishSubscribe_PubSubCapablities_MaxPublishedDataSets = 32841,
    PublishSubscribe_PubSubCapablities_MaxStandaloneSubscribedDataSets = 32842,
    PublishSubscribe_PubSubCapablities_SupportSecurityKeyServer = 32843,
