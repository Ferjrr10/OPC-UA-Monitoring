...
async function promoteOpaqueStructure2(session, callMethodResult) {
...
async function promoteOpaqueStructure3(session, callMethodResults) {
    ...
    const promises = callMethodResults.map(async (x) => promoteOpaqueStructure2(session, x));
