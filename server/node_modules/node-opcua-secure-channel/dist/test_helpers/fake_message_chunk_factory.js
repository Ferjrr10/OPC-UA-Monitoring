...
const receiverPublicKey = fs_1.default.readFileSync(getFixture("certs/server_public_key_1024.pub", "utf-8")).toString();
...
function iterateOnSignedAndEncryptedMessageChunks(buffer, callback) {
    ...
    const options = {
        chunkSize: 2048,
        cipherBlockSize: 128,
        encryptBufferFunc: (chunk) => (0, node_opcua_crypto_1.publicEncrypt_long)(chunk, receiverPublicKey, 128, 11, node_opcua_crypto_1.PaddingAlgorithm.RSA_PKCS1_PADDING),
