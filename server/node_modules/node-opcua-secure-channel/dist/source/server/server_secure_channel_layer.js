...
var _a, _ServerSecureChannelLayer_counter, _ServerSecureChannelLayer_status, _ServerSecureChannelLayer_open_secure_channel_onceClose, _ServerSecureChannelLayer_abort_has_been_called, _ServerSecureChannelLayer_idVerification, _ServerSecureChannelLayer_transport_socket_close_listener;
...
class ServerSecureChannelLayer extends events_1.EventEmitter {
    ...
    constructor(options) {
        ...
        this.transport = new node_opcua_transport_1.ServerTCP_transport({ adjustLimits: options.adjustTransportLimits });
    ...
    init(socket, callback) {
        ...
        this.transport.on("close", __classPrivateFieldGet(this, _ServerSecureChannelLayer_transport_socket_close_listener, "f"));
    }
    /**
    ...
    send_response(msgType, response, message, callback) {
        ...
        if (utils_1.doTraceServerMessage) {
            (0, utils_1.traceResponseMessage)(response, this.securityToken.channelId, __classPrivateFieldGet(this, _ServerSecureChannelLayer_counter, "f"));
        }
    ...
    _set_lifetime(requestedLifetime) {
        ...
        if (this.revisedLifetime === 0) {
            ...
            this.revisedLifetime = Math.max(_a.g_MinimumSecureTokenLifetime, this.revisedLifetime);
        }
    ...
    _stop_open_channel_watch_dog() {
        ...
        if (__classPrivateFieldGet(this, _ServerSecureChannelLayer_open_secure_channel_onceClose, "f")) {
            this.transport.removeListener("close", __classPrivateFieldGet(this, _ServerSecureChannelLayer_open_secure_channel_onceClose, "f"));
    ...
    _install_wait_for_open_secure_channel_request_timeout(callback, timeout) {
        ...
        this.transport.prependOnceListener("close", __classPrivateFieldGet(this, _ServerSecureChannelLayer_open_secure_channel_onceClose, "f"));
    ...
    _on_initial_open_secure_channel_request(callback, request, msgType, requestId, channelId) {
        ...
        if (!(request instanceof services_1.OpenSecureChannelRequest)) {
            ...
            warningLog(chalk_1.default.red("ERROR"), "BadCommunicationError: expecting a OpenChannelRequest as first communication message");
        ...
        this._process_certificates(message, (err, statusCode) => {
            ...
            if (statusCode.isNotGood()) {
                ...
                debugLog(chalk_1.default.cyan(description), chalk_1.default.bgCyan.yellow(statusCode.toString()));
        ...
        this.checkCertificateCallback(certificate, (err, statusCode) => {
            ...
            if (this.receiverCertificate) {
                ...
                (0, node_opcua_crypto_1.extractPublicKeyFromCertificate)(this.receiverCertificate, (err, keyPem) => {
                    if (!err) {
                        if (keyPem) {
                            this.receiverPublicKey = (0, crypto_1.createPublicKey)(keyPem);
    ...
    _handle_OpenSecureChannelRequest(serviceResult, message, callback) {
        ...
        if (nonceAlreadyBeenUsed(this.clientNonce)) {
            warningLog(chalk_1.default.red("SERVER with secure connection: Nonce has already been used"), this.clientNonce.toString("hex"));
        ...
        if (cryptoFactory) {
            ...
            this.serverNonce = (0, crypto_1.randomBytes)(cryptoFactory.symmetricKeyLength);
            if (this.clientNonce.length !== this.serverNonce.length) {
                warningLog(chalk_1.default.red("warning client Nonce length doesn't match server nonce length"), this.clientNonce.length, " !== ", this.serverNonce.length);
                // what can we do
                // - just ignore it ?
    ...
    _on_OpenSecureChannelRequestError(serviceResult, description, message, callback) {
        ...
        setTimeout(() => {
            this.send_response("ERR", new services_1.ServiceFault({
                ...
                callback(new Error(description + " statusCode = " + serviceResult.toString()));
            });
        }, _a.throttleTime); // Throttling keep connection on hold for a while.
    }
}
exports.ServerSecureChannelLayer = ServerSecureChannelLayer;
_a = ServerSecureChannelLayer, _ServerSecureChannelLayer_counter = new WeakMap(), _ServerSecureChannelLayer_status = new WeakMap(), _ServerSecureChannelLayer_open_secure_channel_onceClose = new WeakMap(), _ServerSecureChannelLayer_abort_has_been_called = new WeakMap(), _ServerSecureChannelLayer_idVerification = new WeakMap(), _ServerSecureChannelLayer_transport_socket_close_listener = new WeakMap();
